            ...
            function (require, module, exports) {
                ...
                module.exports = {
                    enable: function (instance) {
                        ...
                        // Zoom Group
                        var zoomGroup = document.createElementNS(
                            SvgUtils.svgNS,
                            "g"
                        );
                    ...
                    _createZoomIn: function (instance) {
                        var zoomIn = document.createElementNS(
                            SvgUtils.svgNS,
                            "g"
                        );
                        ...
                        var zoomInShape = document.createElementNS(
                            SvgUtils.svgNS,
                            "path"
                        );
                    ...
                    _createZoomReset: function (instance) {
                        ...
                        var resetPanZoomControlBackground =
                            document.createElementNS(SvgUtils.svgNS, "rect"); // TODO change these background space fillers to rounded rectangles so they look prettier
                        ...
                        resetPanZoomControl.appendChild(
                            resetPanZoomControlBackground
                        );

                        var resetPanZoomControlShape1 =
                            document.createElementNS(SvgUtils.svgNS, "path");
                        ...
                        resetPanZoomControl.appendChild(
                            resetPanZoomControlShape1
                        );

                        var resetPanZoomControlShape2 =
                            document.createElementNS(SvgUtils.svgNS, "path");
                    ...
                    _createZoomOut: function (instance) {
                        // zoom out
                        var zoomOut = document.createElementNS(
                            SvgUtils.svgNS,
                            "g"
                        );
                        ...
                        var zoomOutShape = document.createElementNS(
                            SvgUtils.svgNS,
                            "path"
                        );
            ...
            function (require, module, exports) {
                ...
                ShadowViewport.prototype.init = function (viewport, options) {
                    ...
                    this.requestAnimationFrame =
                        Utils.createRequestAnimationFrame(
                ...
                ShadowViewport.prototype.processCTM = function () {
                    ...
                    if (this.options.center) {
                        var offsetX =
                                (this.options.width -
                                    (this.viewBox.width + this.viewBox.x * 2) *
                                        newCTM.a) *
                                0.5,
                            offsetY =
                                (this.options.height -
                                    (this.viewBox.height + this.viewBox.y * 2) *
                                        newCTM.a) *
                                0.5;
                 ...
                 * @return {Float} zoom scale
                 */
                ShadowViewport.prototype.computeRelativeZoom = function (
                    scale
                ) {
                ...
                ShadowViewport.prototype.setCTM = function (newCTM) {
                    ...
                    if (willZoom || willPan) {
                        ...
                        // Before pan
                        if (willPan) {
                            var preventPan = this.options.beforePan(
                                    this.getPan(),
                                    {
                                        x: newCTM.e,
                                        y: newCTM.f,
        ...
        4: [
            function (require, module, exports) {
                        ...
                        ),
                        {
                            ...
                            beforeZoom: function (oldScale, newScale) {
                                if (that.viewport && that.options.beforeZoom) {
                                    return that.options.beforeZoom(
                                        oldScale,
                                        newScale
                                    );
                                }
                    ...
                    if (this.options.customEventsHandler != null) {
                        this.options.customEventsHandler.init({
                            ...
                            eventsListenerElement:
                                this.options.eventsListenerElement,
                        ...
                        if (haltEventListeners && haltEventListeners.length) {
                            for (
                                var i = haltEventListeners.length - 1;
                                i >= 0;
                                i--
                            ) {
                                if (
                                    this.eventListeners.hasOwnProperty(
                ...
                SvgPanZoom.prototype.handleMouseWheel = function (evt) {
                    ...
                    if (this.state == "pan"){ // Don't scroll when is moving the SvgPanZoom
                        evt.preventDefault();
                    }
                    ...
                    if (this.state !== "pan") {
                        if (!evt.ctrlKey && !evt.shiftKey) { // Only work when CTRL or SHIFT key is pressed
                            return;
                        }
                    ...
                    if (
                        ...
                        delta =
                            evt.deltaY === 0
                                ? 0
                                : Math.abs(evt.wheelDelta) / evt.deltaY;
                    }
                ...
                SvgPanZoom.prototype.handleDblClick = function (evt) {
                    ...
                    if (evt.shiftKey) {
                        zoomFactor =
                            1 / ((1 + this.options.zoomScaleSensitivity) * 2); // zoom out when shift key pressed
                    } else {
                        zoomFactor =
                            (1 + this.options.zoomScaleSensitivity) * 2;
                    }
                 ...
                 */
                SvgPanZoom.prototype.getTouchDistance = function(touch1, touch2) {
                    return Math.sqrt(
                 ...
                 * @param  {Touch} touch1
                 * @param  {Touch} touch2
                 * @return {Object} { x, y } midpoint coordinates
                 */
                SvgPanZoom.prototype.getTouchMidpoint = function(touch1, touch2) {
                    return {
                ...
                SvgPanZoom.prototype.handleTouchMove = function (evt) {
                    ...
                    if (evt.touches && evt.touches.length === 2 && this.options.zoomEnabled && this.pinchZoomEnabled) {
                    ...
                    if (!this.publicInstance) {
                        this.publicInstance = this.pi = {
                            ...
                            enablePinchZoom: function () {
                                that.pinchZoomEnabled = true;
                                return that.pi;
                            },
                            disablePinchZoom: function () {
                                that.pinchZoomEnabled = false;
                                return that.pi;
                            },
                            isPinchZoomEnabled: function () {
                                return !!that.pinchZoomEnabled;
                            },
                            ...
                            setBeforePan: function (fn) {
                                that.options.beforePan =
                                    fn === null
                                        ? null
                                        : Utils.proxy(fn, that.publicInstance);
                                return that.pi;
                            },
                            ...
                            zoomIn: function () {
                                this.zoomBy(
                                    1 + that.options.zoomScaleSensitivity
                                );
                                return that.pi;
                            },
                            zoomOut: function () {
                                this.zoomBy(
                                    1 / (1 + that.options.zoomScaleSensitivity)
                                );
                                return that.pi;
                            },
                            getZoom: function () {
                        ...
                        if (!viewport) {
                            ...
                            if (!!svgChildren && svgChildren.length > 0) {
                                for (var i = svgChildren.length; i > 0; i--) {
                                    ...
                                    if (
                                        svgChildren[svgChildren.length - i]
                                            .nodeName !== "defs"
                                    ) {
                    ...
                    refreshDefsGlobal: Utils.throttle(
                        function () {
                            ...
                            for (var i = 0; i < allDefsCount; i++) {
                                ...
                                thisDefs.parentNode.insertBefore(
                                    thisDefs,
                                    thisDefs
                                );
                            }
                ...
                module.exports = {
                    ...
                    isDblClick: function (evt, prevEvt) {
                        ...
                        // Try to compare events
                            ...
                            var timeStampDiff =
                                    evt.timeStamp - prevEvt.timeStamp, // should be lower than 250 ms
                                touchesDistance = Math.sqrt(
                                    Math.pow(evt.clientX - prevEvt.clientX, 2) +
                                        Math.pow(
                                            evt.clientY - prevEvt.clientY,
                                            2
                                        )
                                );
                    ...
                    throttle: function (func, wait, options) {
                        ...
                        var later = function () {
                            previous =
                                options.leading === false ? 0 : that.now();
                            timeout = null;
