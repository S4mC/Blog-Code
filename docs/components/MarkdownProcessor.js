...
`);let t=[];function n(e){let n=e,t=[],i=0;for(;n<s.length;){const e=s[n],o=e.trim();if(o===":::"){if(i===0)break;i--,t.push(e)}else o.startsWith(":::")?(i++,t.push(e)):t.push(e);n++}return t=o(t),[t,n]}for(let e=0;e<s.length;e++){const i=s[e],o=i.trim();if(o.startsWith(":::conector")){t.push(""),t.push(`<div class="content-conector">`);const[s,o]=n(e+1),i=processMarkdownBlocks(s.join(`
